...
enum {
    ...
    // GUARD CHANNEL: bits 0-3 are used to set a key as the guard channel. Valid values 0-6,
...
enum power_regs {
    ...
    // 8 bit value to determine how long any key can be in touch before it recalibrates itself
    // 0 = off | 1 = 160ms | 2 = 320ms | 3 = 480ms | 4 = 640ms | 255 = 40.8s
    // Default value: 180(160ms*180 = 28.8s)
